...
- run_id: `python-proof-loop-smoke-20260403T155625Z`
...
- most stable slice: `frontend=python|tier=A|profile=R|pipeline_stage=h_to_l|construct_family=async-await|fixture_set=python-tier-a` (score `100.0`)
- most failure-dense slice: `frontend=python|tier=A|profile=R|pipeline_stage=h_to_l|construct_family=async-await|fixture_set=python-tier-a` (density `0.0`)
- fastest improving slice: `frontend=python|tier=A|profile=R|pipeline_stage=h_to_l|construct_family=async-await|fixture_set=python-tier-a` (delta `0.0`)
