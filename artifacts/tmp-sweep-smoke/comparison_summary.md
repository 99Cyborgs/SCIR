...
- run_id: `python-proof-loop-smoke-20260403T163241Z`
- corpus_manifest_hash: `sha256:71b2ed0546551abf292b4ad1ee5912546386936f547c4925a856f6488dbd22a4`
- metrics: `LCR, GR, SE, SCPR, round_trip`

## Aggregate Deltas

- `delta_vs_source`: `{'LCR': 0.4912, 'GR': 0.0, 'SE': 0.0779, 'SCPR': 0.0, 'round_trip': 0.0}`
- `delta_vs_ast`: `{'LCR': -5.4035, 'GR': 0.0, 'SE': 0.1475, 'SCPR': 0.0, 'round_trip': 0.0}`
- `delta_vs_normalized`: `{'LCR': 0.4912, 'GR': 0.0, 'SE': 0.0428, 'SCPR': 0.0, 'round_trip': 0.0}`
