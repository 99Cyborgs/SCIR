    ...
    "constructs": (
        ...
        },
        {
            ...
            "checklist": {
                ...
                "parser": "yes",
                "validator": "yes",
                "lowering": "yes for the exact `b_while_call_update` and `b_while_break_continue` slices",
                "reconstruction": "yes for the exact `b_while_call_update` and `b_while_break_continue` slices",
                "tests": "yes",
                "mvp_status": "subset-bound executable support",
                "action_taken": "kept as exact-shape proof-loop support; broader loop forms remain deferred",
            },
        },
        {
            "construct": "`break`",
            ...
            "checklist": {
                ...
                "parser": "yes",
                "validator": "yes",
                "lowering": "yes for the exact `b_while_break_continue` slice",
                "reconstruction": "yes for the exact `b_while_break_continue` slice",
                "tests": "yes",
                "mvp_status": "subset-bound executable support",
                "action_taken": "kept as an exact-shape proof-loop control form; broader break forms remain deferred",
            },
        },
        {
            "construct": "`continue`",
            ...
            "checklist": {
                ...
                "tests": "yes",
                "mvp_status": "subset-bound executable support",
                "action_taken": "kept as an exact-shape proof-loop control form; broader continue forms remain deferred",
            },
        },
        {
            ...
            "checklist": {
                ...
                "parser": "yes",
                "validator": "yes",
                "lowering": "yes for the exact `d_try_except` slice",
                "reconstruction": "yes for the exact `d_try_except` slice",
                "tests": "yes",
                "mvp_status": "subset-bound executable support",
                "action_taken": "kept as an exact-shape proof-loop slice; broader forms remain deferred",
            },
        },
        {
